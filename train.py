...
def parse_args():
    ...
    parser.add_argument('--mixup-alpha', type=float, default=0.2, help='Alpha parameter for Mixup augmentation (0.0 to disable)')
    ...
    parser.add_argument('--drop-path-max', type=float, default=0.2, help='Maximum DropPath probability (Stochastic Depth)')
